<div class="card">
		...
		<li><?php _e('The second goal is to propose an easy display of this data by a simple <a href="https://www.openstreetmap.org/">OSM map</a> (with <a href="https://leafletjs.com/">Leaflet</a>) and the possibility to customized the popup\'s marker rendering.', 'ctp-to-map-store'); ?>
		</li></ul></p>
		...
		<p>
			...
			<?php _e('You could help on the repository:', 'ctp-to-map-store'); ?> <br> <a href="https://github.com/lriaudel/cpt-to-map-store">https://github.com/lriaudel/cpt-to-map-store</a>
		</p>
		<hr>
		<p>
